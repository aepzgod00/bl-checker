        ...
        if st.button("🚀 เริ่มตรวจสอบเปรียบเทียบคำสะกดอย่างละเอียด", use_container_width=True):
            with st.spinner("🤖 สมองกลกำลังวิเคราะห์ตารางและคำนวณมูลค่าตัวเลข..."):
                try:
                    ...
                    Description of Goods เอาตามที่ลูกค้าEnterมาคือในกรอบหรือที่ลูกค้าติ๊กถูก อันนี้ต้องใช้Logicนิดนึง เอาแค่ที่ลูกค้าEnterมาให้ พวกข้อมูลตู้หรืออะไรพวกนี้ถ้าลูกค้าไม่ได้ตีกรอบหรือยืนยันมาว่าควรเอามา ก็ไม่ต้องมี
                    ...
                    ** ตรวจเช็คให้ดีเพราะบางครั้งมันมีพวกตัวเลขพวก#มองให้ถูกอย่าผิดพลาด ใช้Logicของมนุษย์ที่ชอบเช็คคำผิด **
                    ...
                    ข้อควรระวังเรื่องการอ่านอักษร (OCR Error): ในช่อง Description of Goods หากเจอข้อความประเภท "Hi Alumina sand #35S" หรือ "#22S" แล้วระบบตรวจจับเพี้ยนเห็นเครื่องหมาย '#' เป็นเลข '2' (เช่น เห็นเป็น 235S) ให้ใช้ Logic คาดการณ์บริบทความน่าจะเป็น (Contextual Logic) หากคำรอบข้างสะกดเหมือนกันและในใบ Amend ระบุ #35S ชัดเจน ให้ถือว่าเป็นตัวเดียวกันและปรับรายงานให้เป็น 'MATCH' (แต่ให้โน้ตหมายเหตุเล็กๆ ไว้ว่าเป็นการแก้ปัญหาจากฟอนต์เอกสารเบียดกัน)
