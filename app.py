...
API_KEY = "AQ.Ab8RN6IFDPsA70Ts5cLUC0TMYsTCZFDWUmo6cqFU_epg-saGeA"
    ...
    # 🔍 ================== [ฝั่งที่ 1: ตรวจสอบเอกสาร] ==================
        ...
        with st.container():
            ...
            if bl_files and amend_files:
                    ...
                    with st.spinner("กำลังดำเนินการตรวจสอบความถูกต้องของระบบเอกสาร..."):
                        try:
                            ...
                            prompt_instruction = (
                                ...
                                "CRITICAL REQUIREMENT: There are multiple Bill of Lading (B/L) documents inside the payload (e.g., PKEBKK2660031, PKEBKK2660034, etc.). You must scan ALL of them and generate verification report rows for EVERY SINGLE B/L number found. Do not drop or miss any B/L numbers.\n\n"
                ...
                st.info("💡 กรุณาอัปโหลดเอกสารทั้งสองฝั่งให้ครบถ้วน ปุ่มประมวลผลการเปรียบเทียบข้อมูลจึงจะปรากฏขึ้นมา")
